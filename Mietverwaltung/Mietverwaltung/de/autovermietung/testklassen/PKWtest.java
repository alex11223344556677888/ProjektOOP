...
public class PKWtest  {
	...
	public static void main(String[] args) {
        ...
        TerminVerwaltung tv = new TerminVerwaltung();
        ...
        pkwVerwaltung.pkwHinzufuegen("SUV", "Mercedes", "Automatik", 150, "Silber", "Luxus", "Benzin", true, true, 2020, 5, 7, 180, 22, "A", 9012, "ME-9012", true, true, false, true, true);
        ...
        pkwVerwaltung.pkwHinzufuegen("Limousine", "BMW", "Automatik", 120, "Weiß", "Komfort", "Benzin", true, true, 2019, 4, 5, 140, 20, "A", 7890, "BM-7890", true, true, false, true, false);
        ...
        pkwVerwaltung.pkwHinzufuegen("Coupe", "Porsche", "Automatik", 300, "Rot", "Luxus", "Benzin", true, true, 2020, 2, 4, 220, 26, "A", 5678, "PO-5678", true, true, false, true, true);
        pkwVerwaltung.pkwHinzufuegen("Limousine", "Audi", "Schaltgetriebe", 110, "Blau", "Komfort", "Diesel", true, true, 2018, 4, 5, 140, 20, "A", 9012, "AU-9012", true, true, false, true, false);
        ...
        pkwVerwaltung.pkwHinzufuegen("SUV", "Mercedes", "Schaltgetriebe", 130, "Silber", "Luxus", "Diesel", true, true, 2021, 5, 7, 160, 22, "A", 1234, "ME-1234", true, true, false, true, true);
        ...
        pkwVerwaltung.pkwHinzufuegen("Limousine", "Audi", "Automatik", 125, "Silber", "Komfort", "Diesel", true, true, 2019, 4, 5, 140, 20, "A", 3456, "AU-3456", true, true, false, true, false);
        pkwVerwaltung.pkwHinzufuegen("SUV", "Mercedes", "Schaltgetriebe", 145, "Weiß", "Luxus", "Benzin", true, true, 2021, 5, 7, 160, 22, "A", 1234, "ME-1234", true, true, false, true, true);
        ...
        pkwVerwaltung.pkwHinzufuegen("Cabrio", "Porsche", "Automatik", 350, "Rot", "Luxus", "Benzin", true, true, 2020, 2, 4, 250, 28, "A", 1111, "PO-1111", true, true, false, true, true);
        pkwVerwaltung.pkwHinzufuegen("Limousine", "BMW", "Schaltgetriebe", 115, "Blau", "Komfort", "Benzin", true, true, 2018, 4, 5, 130, 20, "A", 9012, "BM-9012", true, true, false, true, false);
        ...
        pkwVerwaltung.pkwHinzufuegen("SUV", "Mercedes", "Schaltgetriebe", 160, "Silber", "Luxus", "Diesel", true, true, 2021, 5, 7, 180, 24, "A", 1234, "ME-1234", true, true, false, true, true);
        pkwVerwaltung.pkwHinzufuegen("Kombi", "VW", "Schaltgetriebe", 90, "Schwarz", "Komfort", "Diesel", true, true, 2017, 4, 5, 130, 18, "B", 3457, "VW-3457", false, true, false, false, false);
        pkwVerwaltung.pkwHinzufuegen("SUV", "Audi", "Automatik", 200, "Silber", "Luxus", "Benzin", true, true, 2021, 5, 7, 160, 22, "A", 6789, "AU-6789", true, true, false, true, true);
        pkwVerwaltung.pkwHinzufuegen("Cabrio", "BMW", "Schaltgetriebe", 150, "Rot", "Komfort", "Elektro", true, true, 2020, 2, 4, 140, 24, "A", 2346, "BM-2346", true, true, true, true, false);
        pkwVerwaltung.pkwHinzufuegen("Kleinwagen", "Mercedes", "Automatik", 70, "Blau", "Basis", "Diesel", false, false, 2013, 3, 4, 100, 16, "B", 5679, "ME-5679", false, false, false, false, false);
        pkwVerwaltung.pkwHinzufuegen("Coupe", "Opel", "Schaltgetriebe", 180, "Weiß", "Luxus", "Benzin", true, true, 2022, 2, 4, 220, 26, "A", 9013, "OP-9013", true, true, false, true, true);
        pkwVerwaltung.pkwHinzufuegen("Limousine", "Porsche", "Automatik", 300, "Schwarz", "Komfort", "Diesel", true, true, 2019, 4, 5, 200, 20, "A", 3458, "PO-3458", true, true, false, true, false);
        pkwVerwaltung.pkwHinzufuegen("Kombi", "Audi", "Schaltgetriebe", 100, "Silber", "Basis", "Benzin", false, false, 2015, 4, 5, 120, 18, "B", 2347, "AU-2347", false, false, false, false, false);
        pkwVerwaltung.pkwHinzufuegen("SUV", "BMW", "Automatik", 250, "Rot", "Luxus", "Elektro", true, true, 2022, 5, 7, 180, 24, "A", 6780, "BM-6780", true, true, true, true, true);
        pkwVerwaltung.pkwHinzufuegen("Cabrio", "VW", "Schaltgetriebe", 160, "Weiß", "Komfort", "Benzin", true, true, 2021, 2, 4, 140, 22, "A", 5670, "VW-5670", true, true, false, true, false);
        pkwVerwaltung.pkwHinzufuegen("Limousine", "Mercedes", "Automatik", 180, "Blau", "Luxus", "Diesel", true, true, 2020, 4, 5, 160, 20, "A", 3459, "ME-3459", true, true, false, true, true);
